...
export function Tabbar(){
  const navigate = useNavigate();
    ...
    return<div className="flex justify-normal bg-zinc-50 fixed w-screen h-14">
        ...
        <img src={logo} alt="logo" width={60} height={60} className="w-[60] h-auto -mt-2 -ml-2" 
        onClick={(e) => {
          e.preventDefault();
          navigate("/");
        }}></img>
        ...
        <div className="flex ml-auto">
              <Button  className=" bg-corporateBlue text-white p-4 rounded-sm mt-3 mb-3 mr-3 ml-2 hover:bg-corporateBlue font-vietnam ">
            Workflow Editor
          </Button>
