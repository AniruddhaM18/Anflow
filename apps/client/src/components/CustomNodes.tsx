...
export const TriggerNode = ({data} :{data: any}) => {
  ...
  return (
    <div className={`relative flex items-center justify-center border ${borderClass} bg-slate-300 border-2 border  p-2 rounded-l-lg`}>
...
export const ActionNode = ({data} :{data: any}) => {
    ...
    return (
      <div className={`flex items-center justify-center bg-neutral-50 rounded-md border border-2  ${borderClass} p-2 ${data.type === "agent" ? "w-28" : ""}`}>
